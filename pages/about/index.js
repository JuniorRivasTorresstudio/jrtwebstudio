     ...
     gap-x-6'>
      ...
      <div className='flex-1 flex flex-col justify-center'>text
        <motion.h2 
          ...
          className='h2'
          >
          Capiviting <span className='text-accent'>stories</span>birth magnificient designs.
        </motion.h2>
            <motion.p
            ...
            >
                10 years ago, Ibegan freelancing as a dveloper .Since then , i've done remote work
              for agencies, consulter for startup and collaborated on 
            </motion.p>
      {/*counters*/}
      <motion.div  
